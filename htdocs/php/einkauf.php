    ...
    <div>
        <form id='searchform' action='einkauf.php' method='post'>
            <table>
                ...
                <input id='searchMail' name='searchMail' type='text' size='15'
                       value='<?php if (isset($_POST['searchMail'])) echo $_POST['searchMail']; ?>'/>
                <br> <br>
                Bestellnumer eingeben:
                <input id='searchNr' name='searchNr' type='text' size='15'
                       value='<?php if (isset($_POST['searchNr'])) echo $_POST['searchNr']; ?>'/>
                <br> <br>
...
<div>
    ...
    <form id='insertform' action='confirm.php' method='post'>
        ...
        <center>
            ...
            <input id="bestellnummer" name="bestellnummer" type="hidden"
                   value="<?php echo $order->getBestellnummer() ?>"/>
            <?php
