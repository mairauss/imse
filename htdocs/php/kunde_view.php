            ...
            <form id='insertform' action='kunde.php' method='get'>
                <center>
                    ...
                    <table style='border: 5px solid #DDDDDD'>
                        ...
                        <tr>
                            <td>
                                <input id='kname' name='kname' type='text' size='50'
                                       value='<?php if (isset($_GET['kname'])) echo $_GET['kname']; ?>'/>
                            </td>
                            <td>
                        ...
                        <table style='border: 5px solid #DDDDDD'>
                            ...
                            <tr>
                                <td>
                                    <input id='kgeburtsdatum' name='kgeburtsdatum' type='text' size='10'
                                           value='<?php if (isset($_GET['kgeburtsdatum'])) echo $_GET['kgeburtsdatum']; ?>'/>
                                </td>
                                <td>
                                    <input id='bname' name='bname' type='text' size='15'
                                           value='<?php if (isset($_GET['bname'])) echo $_GET['bname']; ?>'/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
